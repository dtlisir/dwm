...
class HostNode(models.Model):
    ...
    memory = models.IntegerField(blank=True, null=True,verbose_name='内存总量')
    active = models.BooleanField(default=False, blank=True, verbose_name='状态')
    c_running = models.IntegerField(blank=True, null=True,verbose_name='运行数')
    c_paused = models.IntegerField(blank=True, null=True,verbose_name='暂停数')
    c_stopped = models.IntegerField(blank=True, null=True,verbose_name='停止数')
    ...
    c_count = models.IntegerField(blank=True, null=True,verbose_name='容器数')
    i_count = models.IntegerField(blank=True, null=True,verbose_name='镜像数')
